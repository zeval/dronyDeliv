...
# Value of the index number corresponding the maximum weight carryable by a drone in list
MaxWeight = 2

# Value of the index number corresponding the maximum distance a drone in list can travel
MaxDistance = 3

# Value of the index number corresponding the accumulated distance a drone in list has travelled
AccumDistance = 4

# Value of the index number corresponding the autonomy of a drone in list
Autonomy = 5

# Value of the index number corresponding the date when a deliver has been completed and the drone in list has returned to base 
AvailableDate = 6
